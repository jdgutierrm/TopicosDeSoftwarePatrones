...
class Main {
    ...
    public static void main(String args[]) throws IOException{
        ...
        juan.setId(1);
        juan.setNombre("Juan Diego");
        juan.setApellido("Gutierrez Montoya");
        juan.setGenero("Masculino");
        juan.setFechaNacimiento("08/12/1999");
        juan.setEstadocivil("Soltero");

        ClienteMenor andres = new ClienteMenor();
        andres.setId(2);
        andres.setNombre("Andres");
        andres.setApellido("Romero Cardona");
        andres.setGenero("Masculino");
        andres.setFechaNacimiento("15/05/2002");
        andres.setEstadocivil("Soltero");

        ClienteMayor natalia = new ClienteMayor();
        natalia.setId(3);
        natalia.setNombre("Natalia");
        natalia.setApellido("Montoya Meneses");
        natalia.setGenero("femenino");
        natalia.setFechaNacimiento("08/04/1984");
        natalia.setEstadocivil("casada");

        TipoItem type = new TipoLegal();
        type.setDescripcion("jean");
        ...
        factura1.setFechaFactura("09/08/2008");
        factura1.setCliente(juan);
        factura1.setTotalFactura(40000.0);
        factura1.setEstado("pagado");
        factura1.setItems(itemsFacturas);

        Factura factura2 = new FacturaPagada();
        factura2.setNroFactura(2);
        factura2.setFechaFactura("20/01/2019");
        factura2.setCliente(andres);
        factura2.setTotalFactura(125000.0);
        factura2.setEstado("deuda");
        factura2.setItems(itemsFacturas);

        Factura factura3 = new FacturaPagada();
        factura3.setNroFactura(3);
        factura3.setFechaFactura("20/02/2020");
        factura3.setCliente(natalia);
        factura3.setTotalFactura(300000.0);
        ...
        clienteDao.addCliente(andres);
        clienteDao.addCliente(natalia);
        ...
        while(true){
            ...
            if(resA.equals("c")){
                ...
                while(true){
                    System.out.println("A continuacion, se mostraran los items en venta:");
                    itemDao.printItem();
                ...
                if( aspecto.equals("f") ){
                    ...
                    System.out.println("No se realizara ningún cambio.");
                }
